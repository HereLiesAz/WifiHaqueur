...
fun MainScreen(
    ...
    Row(Modifier.fillMaxSize()) {
        AzNavRail {
            ...
            azRailItem(text = "Scan", onClick = onScanClick)
            azRailItem(text = "Attack", onClick = { viewModel.startAttack() })
            azRailItem(text = "Dictionary", onClick = { showDictionaryScreen = true })
        }
        Scaffold(
